...
public class AuditTrailService {
    ...
    public void record(String eventType, UUID organizationId, UUID auditId,
        ...
        record(eventType, organizationId, auditId, actorId, resourceType, resourceId, details, "API");
    }
    ...
    public void recordSystem(String eventType, UUID organizationId, UUID auditId, UUID actorId,
                             String resourceType, UUID resourceId, Map<String, Object> details) {
        record(eventType, organizationId, auditId, actorId, resourceType, resourceId, details, "SYSTEM");
    }

    private void record(String eventType, UUID organizationId, UUID auditId, UUID actorId,
